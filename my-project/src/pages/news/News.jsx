    ...
    <div  className=''>
      <div className='w-[1200px] mx-auto '>
        ...
        <div className='flex mt-20 gap-14'>
          ...
          <div className='w-1/2 '>
            <h1 className='text-3xl'>Office Relocation</h1>
      ...
      <div className="bg-secondary-100 mt-24 py-14">
        <div className=' w-[1200px] mx-auto'>
          ...
          <div className='w-1/2  text-tertiary-100'>
            <h1 className='text-3xl capitalize'> New Credit For Those Purchasing In Birr</h1>
            <p className='text-md mt-3 w-3/4'>
      ...
      <div className='w-[1200px] mx-auto'>
        ...
        <div className='flex gap-14 mt-20'>
          ...
          <div className='w-1/2'>
            <h1 className='text-3xl'> Ayat Upcoming New Community </h1>
            <p className='text-md mt-3 w-3/4'>
       ...
       <div className="bg-secondary-100 mt-24 py-14">
        <div className='w-[1200px] mx-auto'>
          ...
          <div className='w-1/2 text-tertiary-100'>
            <h1 className='text-3xl capitalize'>  Kazanchis Mall Sold Out</h1>
            <p className='text-md mt-3 w-3/4'>
       ...
       <div className='w-[1200px] mx-auto'>
        ...
        <div className='flex gap-14 my-20'>
          ...
          <div className='w-1/2'>
            <h1 className='text-3xl'> Ayat New Website Launch </h1>
            <p className='text-md mt-3 w-3/4'>
