  ...
  return (
    <div className='bg-tertiary-100 py-14'>
      <div className='w-[1200px] mx-auto'>
        <h1 className='text-2xl text-secondary-100 text-center mx-auto'>Get In Touch</h1>
        <p className='w-3/4 text-center text-secondary-200 mx-auto mt-5'>Thank you for visiting AYAT REAL ESTATE. Please complete the form below, so we can provide a quick and efficient service. If this is an urgent matter please Contact our lines:</p>
      <div className='flex mt-8 mb-14 justify-center gap-4'>
        ...
        <div className='grid grid-cols-3 grid-rows-3 gap-12 mt-20 justify-between'>
          ...
          <div className='flex flex-col gap-1'>
            <h1 className='text-secondary-100 text-md font-semibold uppercase'> Addis Home Finder Sales Representative Office</h1>
         ...
         <a className='text-secondary-200' href="https://www.addishomefinder.com">www.addishomefinder.com</a>
              ...
              <div className='flex flex-col gap-1'>
            <h1 className='text-secondary-100 text-md font-semibold uppercase'> Elilta Property Services Sales Representative</h1>
            <p className='text-secondary-200'>Bole Rwanda, Tsion Building, 1st Floor, Bole</p>
            <p className='text-secondary-200'>Addis Ababa, Ethiopia</p>
           
          </div>
              <div className='flex flex-col gap-1'>
            <h1 className='text-secondary-100 text-md font-semibold uppercase'> Marefya Gojoye Marketing Sales Representative Office</h1>
            <p className='text-secondary-200'>22 Mazoria, Baro building infront of Meklit Building, 6th floor, office 604</p>
            <p className='text-secondary-200'>Addis Ababa, Ethiopia</p>
           
          </div>
        </div>
          <Link to="./register" className="bg-primary-200 shadow-lg w-max mx-auto text-secondary-100 px-10 h-10 py-5 text-tertiary flex items-center  rounded-md  tracking-widest ">REGISTER</Link>
      </div>
